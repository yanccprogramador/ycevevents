        ...
        <table class="responsive-table highlight bordered">
            ...
            @foreach($eventos as $events)
                <tr>
                    ...
                    <td>{{$events->data}}</td>
                    <td><a href="/{{$events->id}}/del/{{$events->owner}}" class="btn green waves-effect waves-light">Excluir</a></td>
                    <td><a href="/{{$events->id}}/gerar/{{$events->owner}}" class="btn green waves-effect waves-light">Gerar Lista</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
        <form method="get" action="/cadastre/{{$dono}}">
